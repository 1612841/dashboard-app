...
function LoginBox() {
    ...
    return (
        <div className='content h-100vh d-flex align-items-center align-content-center justify-content-center'>
            <div>
                <div className='d-flex align-items-center justify-content-center mb-28'>
                    <img src='/images/logoB.png' alt='logo' />
                </div>
                <div className='bg-light border-radius-4 px-16 pt-16'>
                    ...
                    <input value={inputs.inputEmail} onChange={(e)=> setInputs({...inputs, inputEmail:e.target.value})} className='w-95% font-size-14 border-radius-4 border py-7 px-8 mb-16' type='text' placeholder='Email here...' />
                    <input value={inputs.inputPassword} onChange={(e)=> setInputs({...inputs, inputPassword:e.target.value})} className='w-95% font-size-14 border-radius-4 border py-7 px-8 mb-16' type='text' placeholder='Password here...' />
                    ...
                    <hr className='my-16 bg-gray-200 opacity-5' />
                    ...
                    <div className='d-flex align-items-center justify-content-right h-70 border-top bg-gray-200 mix-16 border-radius-4'>
                        ...
                        <button className='btn cursor font-size-13 px-16 py-9 mr-16 color-light bg-rgb-blue font-weight-bold border-radius-6' onClick={handleSubmit}>Login to Dashboard</button>
                    </div>
                </div>
            </div>
        </div>
