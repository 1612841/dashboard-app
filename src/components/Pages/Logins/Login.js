        ...
        <div className='d-flex'>
            ...
            <div className="col-md-8 form-login d-flex justify-content-center h-100vh">
                <div className='w-75%'>
                    ...
                    <h4 className='mb-8'>
                        <span className='font-size-18 font-weight-lighter d-flex flex-1-0-100% mb-8'>Welcome back,</span>
                        <span className='font-size-18 font-weight-lighter d-flex flex-1-0-100% mb-24'>Please sign in to your account.</span>
                    </h4>
                    <h6 className='d-flex mt-3 font-size-16 font-weight-lighter mb-8'>
                        No account?
                        <a className='color-rgb-blue text-decoration-none cursor mx-10' href='/register'>Sign up now</a>
                    </h6>
                    <hr className='w-auto mix-10 my-16' />
                    ...
                    <div className='d-flex align-items-center align-content-center justify-content-right'>
                        <a className='font-size-13 cursor py-8 px-16 text-decoration-none color-rgb-blue font-weight-bold' href='/forgotpassword'>Recover Password</a>
                        <button className='btn cursor font-size-13 py-8 px-16 color-light bg-rgb-blue font-weight-bold border-radius-6' onClick={handleSubmit}>Login to Dashboard</button>
                    </div>
                </div>
            </div>
        </div>
