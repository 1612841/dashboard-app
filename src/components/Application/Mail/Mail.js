        ...
        <div className='h-100% w-100% m-0 p-0'>
            <div className="d-flex justify-content-space-between align-items-center h-110 ml-280 bg-blue-white px-25" >
                <div className='d-flex justify-content-left'>
                    ...
                    <div className='title-mail align-items-center d-block align-self-center'>
                        <h1 className='font-size-20 font-weight-lighter mb-5'>Mailbox</h1>
                        <p className='font-size-14 font-weight-lighter mt-5'>Create stunning UIs for your pages with these layout components.</p>
                    </div>
                </div>
                <div className="d-flex justify-content-center">
                    <button className='btn py-8 px-13 bg-dark mr-20' type='button' ><i class="fas fa-star font-size-14 color-light"></i></button>
                    <button className='btn color-light py-8 w-110 bg-cyan font-weight-bold' type='button' ><i class="fas fa-toolbox pr-20"></i>Button</button>
                </div>
            </div>
            <div className='main-mail h-867 ml-280 d-flex w-auto'>
                <div className="main-left w-270 h-866 bg-gray-100">
                    ...
                    <div className='d-flex align-item-center align-content-center justify-content-space-between mx-17 h-37 mit-5'>
                        <div className='d-flex align-items-center justify-content-center'>
                            <i class="far fa-comment-alt font-size-16 mr-10"></i>
                            <p className='font-size-14 color-rgb-blue'>Inbox</p>
                        </div>
                        <span className='bg-cyan py-2 px-10 border-radius-160 font-size-12 color-light font-weight-bold'>8</span>
                    </div>
                    ...
                    <div className='d-flex align-item-center align-content-center justify-content-space-between mx-17 h-37'>
                        ...
                        <span className='bg-rgb-green py-2 px-10 border-radius-4 font-size-12 color-light font-weight-bold'>NEW</span>
                    </div>
                    <hr className='my-8 color-gray-300 font-weight-lighter' />
                    <div className='d-flex align-item-center align-content-center justify-content-space-between mx-17 h-37'>
                        <div className='d-flex align-items-center justify-content-center'>
                            <i class="fas fa-file-import font-size-16 mr-10"></i>
                    ...
                    <div className='d-flex align-item-center align-content-center justify-content-space-between mx-17 h-37'>
                        ...
                        <span className='bg-rgb-yellow py-2 px-10 border-radius-4 font-size-12 color-dark font-weight-bold'>512</span>
                    </div>
                    <hr className='my-8 color-gray-300 font-weight-lighter' />
                    ...
                    </div>
                    {
                        tagImportant.map((e,index) => 
                            <div key={index} className='d-flex align-item-center align-content-center mx-24 h-34 '>
                ...
                <div className='main-right w-100% h-867'>
                    <div className='w-100% h-62 d-flex justify-content-space-between'>
                        <div className='h-100% d-flex align-items-center align-content-center'>
                            <h1 className='font-size-24 font-weight-100 mt-3 ml-24'>Inbox</h1>
                            <button className='bg-transparent font-size-13 font-weight-500 cursor-pointer px-17 py-17 border-none color-rgb-blue'>
                                <i class="fas fa-angle-down"></i>
                            </button>
                        </div>
                        <div className='d-flex align-items-center align-content-center border-none w-246 h-35 justify-content-center mr-24 align-self-center'>
                    ...
                    <hr className='mt-1 mib-1 color-gray-100 font-weight-lighter' />
                    {
                        dataMailbox.map((item,index) => {
                            ...
                            <div key={index} className='row bar-content'>
                                <div className="w-100% h-78 d-flex align-items-center ">
                                    <div className="col-5">
                                        <div className="d-flex align-items-center align-content-center py-18 px-13 ml-13">
                                            ...
                                            <i class="fas fa-star py-18 px-13 ml-30"></i>
                                        </div>
                                        <div className="d-flex align-items-center">
                                            <div className="d-flex align-items-center mr-50 ">
                                                <img className='w-42 h-42 border-radius-50% px-8' src={item.image} alt='hinh' />
                                ...
                                <hr className='mt-1 w-100% color-gray-100 font-weight-lighter align-self-bottom mib-1' />
                            </div>
                            )
                        })
                    }
                    <div className="w-100% h-50 position-absolute t-900 l-600 d-flex align-items-center align-content-center">
                        <button className='btn w-32 h-35 border-none cursor pr-1' onClick={preSlide} type='button'><i class="fas fa-chevron-left"></i></button>
                        {
                        ...
                        <button className='btn w-32 h-35 border-none cursor pr-1' onClick={nextSlide} type='button'><i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
            </div>
            <hr className='my-1 color-gray-300 font-weight-lighter ml-280' />
